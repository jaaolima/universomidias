...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="/buscar_midia/">Buscar mídias</a></li>
                    ...
                    <div class="card card-hover-border p-3 flex-lg-row align-items-lg-center gap-5 mb-3 coluna-card">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            <div class="d-flex flex-stack gap-5">
                                ...
                                <i class="ki-outline ki-heart text-danger fs-3 me-2"></i>									</div>
                            ...
                            <div class="d-flex">
                                <a target="_blank" href='https://wa.me/5561984487408?text=Olá,%20gostaria%20de%20mais%20informações%20sobre%20essa%20mídia%0A%0A<?php echo $retorno[$i]['ds_localidade']; ?>(<?php echo $retorno[$i]['ds_descricao']; ?>)' class="btn btn-success btn-sm m-3 text-start">
                                    Saber Mais
        ...
        <footer class="py-5 bg-black" id="contato">
            ...
            <div class="container px-5 mt-5"><p class="m-0 text-center text-white small">Copyright &copy; Your Website 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
            ...
            $(document).ready(function() { 
                ...
                $('#id_tipo_filtro').change(function () {
                    ...
                    if(tipo == 'todos'){
                        ...
                        $('#lista .coluna-card').each(function () {
                            if($(this).find('input[name="tipo"]').val() == tipo) {
                                $(this).closest('.coluna-card').show();
                                return true;
                            } else {
                                $(this).closest('.coluna-card').hide(); 
                ...
                $('#id_localizacao_filtro').change(function () {
                    ...
                    if(localidade == 'todos'){
                        ...
                        $('#lista .coluna-card').each(function () {
                            if($(this).find('input[name="nome"]').val() == localidade) {
                                $(this).closest('.coluna-card').show();
                                return true;
                            } else {
                                $(this).closest('.coluna-card').hide(); 
